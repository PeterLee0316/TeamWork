...
namespace Core.UI
{
    public partial class FormMacroAlignTeach : Form
    {
        ...
        {
            // Patten Display
            CMainFrame.Core.m_Vision.DisplayPatternImage(PRE__CAM, PATTERN_A, picPatternMarkA.Handle);
            CMainFrame.Core.m_Vision.DisplayPatternImage(PRE__CAM, PATTERN_B, picPatternMarkB.Handle);
        ...
        private void TmrTeach_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                strShowData = String.Format("{0:0.0000}", CMainFrame.Core.m_ACS.ServoStatus[(int)EACS_Axis.STAGE1_X].EncoderPos);
                lblStagePosX.Text = strShowData;

                strShowData = String.Format("{0:0.0000}", CMainFrame.Core.m_ACS.ServoStatus[(int)EACS_Axis.STAGE1_Y].EncoderPos);
                lblStagePosY.Text = strShowData;

                strShowData = String.Format("{0:0.0000}", CMainFrame.Core.m_ACS.ServoStatus[(int)EACS_Axis.STAGE1_T].EncoderPos);
                lblStagePosT.Text = strShowData;

#if EQUIP_266_DEV
                strShowData = String.Format("{0:0.0000}", CMainFrame.Core.m_ACS.ServoStatus[(int)EACS_Axis.CAMERA1_Z].EncoderPos);
            ...
            strShowData = String.Format("{0:0.0000} mm", CMainFrame.Core.m_ctrlStage1.GetRoiSize().Width);
            lblRoiWidth.Text = strShowData;

            strShowData = String.Format("{0:0.0000} mm", CMainFrame.Core.m_ctrlStage1.GetRoiSize().Height);
            ...
            if (bRoiWidthNarrow || bRoiWidthWide || bRoiHeightWide || bRoiHeightNarrow)
            {
                ...
                CMainFrame.Core.m_Vision.SetRoiSize(szRoi);
            }            
        ...
        private void btnChangeCam_Click(object sender, EventArgs e)
        {
            ...
            else if (CMainFrame.Core.m_ctrlStage1.GetCurrentCam() == PRE__CAM)
        ...
        private void btnRegisterMarkA_Click(object sender, EventArgs e)
        {
            ...
            // Cam의 Pixel Num을 확인함
            rectSearch.Width = CMainFrame.Core.m_Vision.GetCameraPixelNum(PRE__CAM).Width;
            rectSearch.Height = CMainFrame.Core.m_Vision.GetCameraPixelNum(PRE__CAM).Height;
            
            // 등록할 Mark의 크기를 읽어옴.
            sizeModel = CMainFrame.Core.m_Vision.GetRoiSize();
            rectModel.Width  = sizeModel.Width;
            rectModel.Height = sizeModel.Height;

            // Mark를 등록함.
            CMainFrame.Core.m_Vision.RegisterPatternMark(PRE__CAM, strModel, PATTERN_A, rectSearch, rectModel);
            ...
            // Model Data를 저장함.
            CSearchData patternData = CMainFrame.Core.m_Vision.GetSearchData(PRE__CAM, PATTERN_A);
            ...
            CMainFrame.Core.m_ctrlStage1.TeachMacroAlignA();
            // LJJ need to edit
            //CMainFrame.DataManager.SavePositionData(true, EPositionObject.STAGE1);            
            //CMainFrame.Core.SetPositionDataToComponent(EPositionGroup.STAGE1);
        ...
        private void btnRegisterMarkB_Click(object sender, EventArgs e)
        {
            ...
            CMainFrame.Core.m_Vision.RegisterPatternMark(PRE__CAM, strModel, PATTERN_B, rectSearch, rectModel);
            ...
            CSearchData patternData = CMainFrame.Core.m_Vision.GetSearchData(PRE__CAM, PATTERN_B);
        ...
        private void btnSearchMarkA_Click(object sender, EventArgs e)
        {
            ...
            CMainFrame.Core.m_Vision.RecognitionPatternMark(PRE__CAM, PATTERN_A, out searchData);
        ...
        {
            CResultData searchData = new CResultData();
            CMainFrame.Core.m_Vision.RecognitionPatternMark(PRE__CAM, PATTERN_B, out searchData);
            lblSearchResult.Text = searchData.m_strResult;
        }
        ...
        {
            CMainFrame.Core.m_ctrlStage1.MoveToMacroAlignB();
        }

        private void btnMarkPosTeach1_Click(object sender, EventArgs e)
        {
            CMainFrame.Core.m_ctrlStage1.MoveToMacroTeachA();
        }

        private void btnMarkPosTeach2_Click(object sender, EventArgs e)
        {
            CMainFrame.Core.m_ctrlStage1.MoveToMacroTeachB();
        }
