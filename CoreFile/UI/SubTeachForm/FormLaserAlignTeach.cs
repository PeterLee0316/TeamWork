...
using static Core.Layers.DEF_NST_Scanner;
    ...
    public partial class FormLaserAlignTeach : Form
    {
        ...
        private void btnChangeCam_Click(object sender, EventArgs e)
        {
            if (CMainFrame.Core.m_ctrlStage1.GetCurrentCam() == FINE_CAM)
                CMainFrame.Core.m_ctrlStage1.ChangeMacroVision(picVision.Handle, EVisionOverlayMode.HAIR_LINE);
            else if (CMainFrame.Core.m_ctrlStage1.GetCurrentCam() == PRE__CAM)
                CMainFrame.Core.m_ctrlStage1.ChangeMicroVision(picVision.Handle, EVisionOverlayMode.HAIR_LINE);
            else
        ...
        private void TimerUI_Tick(object sender, EventArgs e)
        {
            ...
            strShowData = String.Format("{0:0.0000} mm", CMainFrame.Core.m_ctrlStage1.GetHairLineWidth());
        ...
        {
            CMainFrame.Core.m_ctrlStage1.LaserAlignInit();
        }

        private void btnMoveLaserStartPos_Click(object sender, EventArgs e)
        {
            CMainFrame.Core.m_ctrlStage1.MoveLaserAlignPosA();
        }
        ...
        private void btnMoveLaserEndMove_Click(object sender, EventArgs e)
        {
            ...
            CMainFrame.Core.m_ctrlStage1.MoveLaserAlignPosB(dLenth);
        }
        ...
        private async void btnLaserProcessStep1_Click(object sender, EventArgs e)
        {
            ...
            var task = Task<int>.Run(() => CMainFrame.Core.m_ctrlStage1.RunLaserProcess());
        ...
        private void btnMoveLaserEndMoveV_Click(object sender, EventArgs e)
        {
            ...
            CMainFrame.Core.m_ctrlStage1.MoveLaserAlignHeightPosB(dLenth);
        }

        private void btnMoveLaserStartPosV_Click(object sender, EventArgs e)
        {
            CMainFrame.Core.m_ctrlStage1.MoveLaserAlignHeightPosA();
        }

        private void btnMoveToLaserH_Click(object sender, EventArgs e)
        {
            CMainFrame.Core.m_ctrlStage1.MoveStageRelative((int)EStagePos.LASER_PROCESS_TURN);
        }

        private void btnMoveToVisionH_Click(object sender, EventArgs e)
        {
            CMainFrame.Core.m_ctrlStage1.MoveStageRelative((int)EStagePos.LASER_PROCESS_TURN, false);
        }
        ...
        private void btnLaserProcessStop_Click(object sender, EventArgs e)
        {
            ...
            CMainFrame.Core.m_ctrlStage1.IsCancelJob_byManual = true;
        }
        ...
        private void btnMoveXBowNext_Click(object sender, EventArgs e)
        {
            ...
            int iResult;
            CPos_XYTZ curPos;
            CMainFrame.Core.m_ctrlStage1.GetStagePos(out curPos);
            curPos.dX = dx;
            iResult = CMainFrame.Core.m_MeStage.MoveStagePos(curPos);
