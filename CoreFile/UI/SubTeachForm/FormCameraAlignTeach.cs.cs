...
namespace Core.UI
{
    public partial class FormCameraAlignTeach : Form
    {
        ...
        {
            if(CMainFrame.Core.m_ctrlStage1.GetCurrentCam()== PRE__CAM)
                CMainFrame.Core.m_ctrlStage1.DoRotateCenterCals(ref MacroRotateCenterPos);
            if (CMainFrame.Core.m_ctrlStage1.GetCurrentCam() == FINE_CAM)
                CMainFrame.Core.m_ctrlStage1.DoRotateCenterCals(ref MicroRotateCenterPos);
            if (CMainFrame.Core.m_ctrlStage1.GetCurrentCam() == INSP_CAM)
                CMainFrame.Core.m_ctrlStage1.DoRotateCenterCals(ref InspectRotateCenterPos);
        }
