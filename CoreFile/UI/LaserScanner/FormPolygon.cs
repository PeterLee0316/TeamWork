...
namespace Core.UI
{
    public partial class FormPolygon : Form
    {
        ...
        {
            CMainFrame.Core.m_Vision.InitialLocalView(INSP_CAM, picVisionZoom.Handle);
        }
        ...
        {
            CMainFrame.Core.m_MeScanner.ShowScanWindow();
        }
        ...
        private void btnImageUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                if(fileData.Length < fileStreamSize)
                    CMainFrame.Core.m_MeScanner.SendBitmap(strIpAddress,dlg.FileName);
                else
                    CMainFrame.Core.m_MeScanner.SendBitmap(strIpAddress,dlg.FileName, true);
            }            
        }
        ...
        //        changeBitmap = CMainFrame.Core.m_MeScanner.ExpandBmpFile(sourceBitmap);
        ...
        private void btnDataUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (iniOpenDlg.ShowDialog() == DialogResult.OK)
            {
                ...
                CMainFrame.Core.m_MeScanner.SendConfig(strIpAddress,filename);
            }            
        ...
        {
            if (CMainFrame.Core.m_Vision == null) return;
            ...
            if (imgSaveDlg.ShowDialog() == DialogResult.OK)
            {
                ...
                CMainFrame.Core.m_Vision.SaveImage(INSP_CAM, filename);
            }
        }
        ...
        private void btnVisionHalt_Click(object sender, EventArgs e)
        {
            ...
            CMainFrame.Core.m_Vision.HaltVideo(INSP_CAM);
        }
        ...
        private void picVisionZoom_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            Size sizeCam = CMainFrame.Core.m_Vision.GetCameraPixelNum(INSP_CAM);
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (m_VisionMode == EVisionMode.MEASUREMENT)
                {
                    ...
                    //CMainFrame.Core.m_Vision.ClearOverlay();
                    CMainFrame.Core.m_Vision.DrawOverlayText(INSP_CAM, textMsg, ptEnd);
                    
                    CMainFrame.Core.m_Vision.DrawOverlayLine(INSP_CAM, ptStart, ptEnd, System.Drawing.Color.Red);
                ...
                if (m_VisionMode == EVisionMode.CALIBRATION)
                {
                    ...
                    CMainFrame.Core.SaveSystemData(null,null, null, null,CMainFrame.DataManager.SystemData_Align, null);
        ...
        private void btnPreCam_Click(object sender, EventArgs e)
        {
            ...
            CMainFrame.Core.m_Vision.DestroyLocalView(INSP_CAM);
            CMainFrame.Core.m_Vision.InitialLocalView(PRE__CAM, picVisionZoom.Handle);
        }
        ...
        private void btnFineCam_Click(object sender, EventArgs e)
        {
            ...
            CMainFrame.Core.m_Vision.DestroyLocalView(INSP_CAM);
            CMainFrame.Core.m_Vision.InitialLocalView(FINE_CAM, picVisionZoom.Handle);
