    ...
    public class MCtrlStage1 : MCtrlLayer
    {
        ...
        private int MoveRotateCenterCalsPosB()
        {
            ...
            if (eRotateCenterStep == ERotateCenterStep.FINE_POS_B)
            {
                ...
                // Stage의 중심을 재 설정한다.
                CMainFrame.DataManager.Pos_Fixed.Pos_Stage1.Pos[(int)EStagePos.STAGE_CENTER].dX = StageRotatePos[(int)ERotateCenterStep.INIT].dX - rotateCenter.dX;
                CMainFrame.DataManager.Pos_Fixed.Pos_Stage1.Pos[(int)EStagePos.STAGE_CENTER].dY = StageRotatePos[(int)ERotateCenterStep.INIT].dY - rotateCenter.dY;
                CMainFrame.DataManager.Pos_Fixed.Pos_Stage1.Pos[(int)EStagePos.STAGE_CENTER].dT = 0.0;
