...
namespace LWDicer.UI
{
    public partial class FormSpinner1Teach : Form
    {
        ...
        private void LoadNozzleTeachingData(int nTeachPos)
        {
            ...
            dFixedN1Pos = CMainFrame.LWDicer.m_DataManager.FixedPos.S1_CleanerPos.Pos[nTeachPos].dT;
            dOffsetN1Pos = CMainFrame.LWDicer.m_DataManager.OffsetPos.S1_CleanerPos.Pos[nTeachPos].dT;
            dModelN1Pos = CMainFrame.LWDicer.m_DataManager.ModelPos.S1_CleanerPos.Pos[nTeachPos].dT;
            ...
            dFixedN2Pos = CMainFrame.LWDicer.m_DataManager.FixedPos.S1_CoaterPos.Pos[nTeachPos].dT;
            dOffsetN2Pos = CMainFrame.LWDicer.m_DataManager.OffsetPos.S1_CoaterPos.Pos[nTeachPos].dT;
            dModelN2Pos = CMainFrame.LWDicer.m_DataManager.ModelPos.S1_CoaterPos.Pos[nTeachPos].dT;
            ...
            // FixedPos
            strFixedPos = Convert.ToString(CMainFrame.LWDicer.m_DataManager.FixedPos.S1_CleanerPos.Pos[nTeachPos].dT);
            GridNozzleTeachTable[3, 1].Text = strFixedPos;

            strFixedPos = Convert.ToString(CMainFrame.LWDicer.m_DataManager.FixedPos.S1_CoaterPos.Pos[nTeachPos].dT);
            GridNozzleTeachTable[3, 2].Text = strFixedPos;

            // ModelPos
            strModelPos = Convert.ToString(CMainFrame.LWDicer.m_DataManager.ModelPos.S1_CleanerPos.Pos[nTeachPos].dT);
            GridNozzleTeachTable[4, 1].Text = strModelPos;

            strModelPos = Convert.ToString(CMainFrame.LWDicer.m_DataManager.ModelPos.S1_CoaterPos.Pos[nTeachPos].dT);
        ...
        private void LoadRotateTeachingData(int nTeachPos)
        {
            ...
            dOffsetPos = CMainFrame.LWDicer.m_DataManager.OffsetPos.S1_RotatePos.Pos[nTeachPos].dT;
            dModelPos = CMainFrame.LWDicer.m_DataManager.ModelPos.S1_RotatePos.Pos[nTeachPos].dT;
            ...
            // FixedPos
            strFixedPos = Convert.ToString(CMainFrame.LWDicer.m_DataManager.FixedPos.S1_RotatePos.Pos[nTeachPos].dT);
            GridRotateTeachTable[3, 1].Text = strFixedPos;

            // ModelPos
            strModelPos = Convert.ToString(CMainFrame.LWDicer.m_DataManager.ModelPos.S1_RotatePos.Pos[nTeachPos].dT);
        ...
        private void GridNozzleTeachTable_PushButtonClick(object sender, GridCellPushButtonClickEventArgs e)
        {
            ...
            if(GetDataMode() == FixedData)
            {
                ...
                if (e.ColIndex == 1)
                {
                    dOffsetPos = CMainFrame.LWDicer.m_DataManager.OffsetPos.S1_CleanerPos.Pos[GetNozzlePosNo()].dT;
                ...
                if (e.ColIndex == 2)
                {
                    dOffsetPos = CMainFrame.LWDicer.m_DataManager.OffsetPos.S1_CoaterPos.Pos[GetNozzlePosNo()].dT;
        ...
        private void GridRotateTeachTable_PushButtonClick(object sender, GridCellPushButtonClickEventArgs e)
        {
            ...
            if(GetDataMode() == FixedData)
            {
                ...
                dOffsetPos = CMainFrame.LWDicer.m_DataManager.OffsetPos.S1_RotatePos.Pos[GetRotatePosNo()].dT;
        ...
        private void BtnNozzleSave_Click(object sender, EventArgs e)
        {
            ...
            if (GetDataMode() == FixedData)
            {
                ...
                CMainFrame.LWDicer.m_DataManager.LoadPositionData(true, EPositionObject.S1_CLEAN_NOZZLE);
            ...
            if(GetDataMode() == OffSetData)
            {
                ...
                CMainFrame.LWDicer.m_DataManager.LoadPositionData(false, EPositionObject.S1_CLEAN_NOZZLE);

                CMainFrame.LWDicer.m_DataManager.SavePositionData(false, EPositionObject.S1_COAT_NOZZLE);
                CMainFrame.LWDicer.m_DataManager.LoadPositionData(false, EPositionObject.S1_COAT_NOZZLE);
            }
        ...
        private void BtnRotateSave_Click(object sender, EventArgs e)
        {
            ...
            if(GetDataMode() == OffSetData)
            {
                ...
                CMainFrame.LWDicer.m_DataManager.LoadPositionData(false, EPositionObject.S1_ROTATE);
            }
        ...
        private void BtnNozzleChangeValue_Click(object sender, EventArgs e)
        {
            ...
            dOffsetN1Pos = CMainFrame.LWDicer.m_DataManager.OffsetPos.S1_CleanerPos.Pos[GetNozzlePosNo()].dT;
            ...
            dOffsetX2Pos = CMainFrame.LWDicer.m_DataManager.OffsetPos.S1_CoaterPos.Pos[GetNozzlePosNo()].dT;
        ...
        private void TmrTeach_Tick(object sender, EventArgs e)
        {
            ...
            strCurPos = Convert.ToString(CMainFrame.LWDicer.m_YMC.ServoStatus[(int)EYMC_Axis.S1_CLEAN_NOZZLE_T].EncoderPos);
            GridNozzleTeachTable[7, 1].Text = strCurPos;

            strCurPos = Convert.ToString(CMainFrame.LWDicer.m_YMC.ServoStatus[(int)EYMC_Axis.S1_COAT_NOZZLE_T].EncoderPos);
            GridNozzleTeachTable[7, 2].Text = strCurPos;

            strCurPos = Convert.ToString(CMainFrame.LWDicer.m_YMC.ServoStatus[(int)EYMC_Axis.S1_CHUCK_ROTATE_T].EncoderPos);
