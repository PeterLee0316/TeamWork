    ...
    public partial class FormSpinner2Teach : Form
    {
        ...
        private void BtnNozzleSave_Click(object sender, EventArgs e)
        {
            ...
            if (GetDataMode() == FixedData)
            {
                ...
                CMainFrame.DataManager.FixedPos.S2_CleanerPos.Pos[GetNozzlePosNo()].dT = Convert.ToDouble(strData);

                strData = GridNozzleTeachTable[3, 2].Text;
                CMainFrame.DataManager.FixedPos.S2_CoaterPos.Pos[GetNozzlePosNo()].dT = Convert.ToDouble(strData);
            ...
            if (GetDataMode() == OffsetData)
            {
                ...
                CMainFrame.DataManager.OffsetPos.S2_CleanerPos.Pos[GetNozzlePosNo()].dT = Convert.ToDouble(strData);

                strData = GridNozzleTeachTable[6, 2].Text;
                CMainFrame.DataManager.OffsetPos.S2_CoaterPos.Pos[GetNozzlePosNo()].dT = Convert.ToDouble(strData);
        ...
        private void BtnRotateSave_Click(object sender, EventArgs e)
        {
            ...
            if (GetDataMode() == FixedData)
            {
                ...
                CMainFrame.DataManager.FixedPos.S2_RotatePos.Pos[GetRotatePosNo()].dT = Convert.ToDouble(strData);
            ...
            if (GetDataMode() == OffsetData)
            {
                ...
                CMainFrame.DataManager.OffsetPos.S2_RotatePos.Pos[GetRotatePosNo()].dT = Convert.ToDouble(strData);
