...
namespace LWDicer.UI
{
    public partial class FormLaserProcessData : Form
    {
        ...
        private void BtnStageChangeValue_Click(object sender, EventArgs e)
        {
            ...
            iResult = CMainFrame.LWDicer.m_ctrlStage1.GetStagePos(out stageCurPos);
        ...
        private void BtnStageMove_Click(object sender, EventArgs e)
        {
            ...
            switch(index)
            {
                case (int)EStagePos.WAIT:
                    CMainFrame.LWDicer.m_ctrlStage1.MoveToStageWaitPos();
                    break;
                ...
                case (int)EStagePos.STAGE_CENTER_INSPECT:
                    CMainFrame.LWDicer.m_ctrlStage1.MoveToStageCenterInspect();
                    break;       
                ...
                case (int)EStagePos.MACRO_CAM_POS:
                    CMainFrame.LWDicer.m_ctrlStage1.MoveToMacroCam();
                    break;
                ...
                case (int)EStagePos.MICRO_ALIGN:
                    CMainFrame.LWDicer.m_ctrlStage1.MoveToMicroAlignA();
                    break;

                case (int)EStagePos.MICRO_ALIGN_TURN:
                    CMainFrame.LWDicer.m_ctrlStage1.MoveToMicroAlignTurnA();
                    break;

                case (int)EStagePos.LASER_PROCESS:
                    CMainFrame.LWDicer.m_ctrlStage1.MoveToProcessPos();
                    break;

                case (int)EStagePos.LASER_PROCESS_TURN:
                    CMainFrame.LWDicer.m_ctrlStage1.MoveToProcessTurnPos();
                    break;
