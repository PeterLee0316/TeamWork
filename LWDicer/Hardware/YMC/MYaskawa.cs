    ...
    public class DEF_Yaskawa
    {
        ...
        public class CMPMotionData
        {
            ...
            public CMPMotionData()
            {
                ...
                //MoveType = (Int16)CMotionAPI.ApiDefs.MTYPE_ABSOLUTE;
...
//             tDevice = m_hDevice[0];
        ...
        public int OriginReturn(int deviceNo = (int)EYMC_Device.ALL, 
            ushort waitMode = (UInt16)CMotionAPI.ApiDefs.DISTRIBUTION_COMPLETED)
        {
            if (deviceNo == (int)EYMC_Device.NULL) return SUCCESS; // return success if device is null
            ...
            // home return
#if !SIMULATION_MOTION_YMC
            // SystemOption : Usually, set to 0. 
            // Set the bit 0 to ON to continue normal axis operation at alarm occurrence. Set the bit 0 to OFF to stop axis operation at alarm occurrence.
            UInt32 systemOption = 1;
            UInt32 rc = CMotionAPI.ymcMoveHomePosition(m_hDevice[deviceNo], MotionData, PositionData, Method, Dir, 0, null, WaitForCompletion, systemOption);
            if (rc != CMotionAPI.MP_SUCCESS)
            {
                return GenerateErrorCode(ERR_YASKAWA_FAIL_SERVO_MOVE_HOME, rc);
            }
