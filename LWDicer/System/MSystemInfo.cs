    ...
    public class MSystemInfo
    {
        ...
        public MSystemInfo()
        {
            arrayObjectInfo = new CObjectInfo[]
            {
                ...
                new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 113, "Spinner1 Ring Blow On & Off", 2000, "Coater", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 114, "Spinner2 Up/Down Cylinder", 2000, "Cleaner", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 115, "Spinner2 DI Valve", 2000, "Cleaner", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 116, "Spinner2 N2 Valve", 2000, "Cleaner", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 117, "Spinner2 Ring Blow On & Off", 2000, "Coater", LOG_ALL, LOG_DAY ),

                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 104, "SHead1 UVCheck Cyl1 Forward/Backward Cylinder", 2000, "SHead1UVCheckCyl1", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 105, "SHead1 UVCheck Cyl2 Forward/Backward Cylinder", 2000, "SHead1UVCheckCyl2", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 106, "SHead1 UVCheck Cyl3 Forward/Backward Cylinder", 2000, "SHead1UVCheckCyl3", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 107, "SHead2 UVCheck Cyl1 Forward/Backward Cylinder", 2000, "SHead2UVCheckCyl1", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 108, "SHead2 UVCheck Cyl2 Forward/Backward Cylinder", 2000, "SHead2UVCheckCyl2", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 109, "SHead2 UVCheck Cyl3 Forward/Backward Cylinder", 2000, "SHead2UVCheckCyl3", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 110, "GHead1 UVCheck Cyl1 Forward/Backward Cylinder", 2000, "GHead1UVCheckCyl1", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 111, "GHead2 UVCheck Cyl1 Forward/Backward Cylinder", 2000, "GHead2UVCheckCyl1", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 112, "SHead1 UVCheck Cyl1 Up/Down Cylinder", 2000, "SHead1UVCheckCylUD", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 113, "SHead2 UVCheck Cyl1 Up/Down Cylinder", 2000, "SHead2UVCheckCylUD", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 114, "SHead1 Cleaner Up/Down Cylinder", 2000, "Cleaner", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 115, "SHead2 Cleaner Up/Down Cylinder", 2000, "Cleaner", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 116, "GHead1 Cleaner Up/Down Cylinder", 2000, "Cleaner", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 117, "GHead2 Cleaner Up/Down Cylinder", 2000, "Cleaner", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 118, "Camera1 Up/Down Cylinder", 2000, "Camera1UD", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 119, "Camera2 Up/Down Cylinder", 2000, "Camera2UD", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 120, "Workbench Forward/Backward Cylinder", 2000, "WorkbenchFB", LOG_ALL, LOG_DAY ),
                //new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 121, "Workbench Up/Down Cylinder", 2000, "WorkbenchUD", LOG_ALL, LOG_DAY ),
