    ...
    public class MSystemInfo
    {
        ...
        public MSystemInfo()
        {
            arrayObjectInfo = new CObjectInfo[]
            {
                ...
                new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 130, "Work Stage Clamp 1 Open & Close", 8000, "Stage", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_HL_CYLINDER, "Cylinder", 131, "Work Stage Clamp 2 Open & Close", 8000, "Stage", LOG_ALL, LOG_DAY ),
	            ...
	            new CObjectInfo( (int)OBJ_ML_OP_PANEL  , "OpPanel",    300, "Mechanical : Operation Panel", 14000, "OpPanel", LOG_ALL, LOG_DAY ),
	            new CObjectInfo( (int)OBJ_ML_STAGE     , "Stage1",     301, "Mechanical : Stage1", 14500, "Stage1", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_ML_PUSHPULL  , "PushPull",   302, "Mechanical : PushPull", 15000, "PushPull", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_ML_ELEVATOR  , "Elevator",   303, "Mechanical : Elevator", 15100, "Elevator", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_ML_COATER    , "Coater1",    304, "Mechanical : Coater1", 15200, "Coater1", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_ML_COATER    , "Coater2",    305, "Mechanical : Coater2", 15200, "Coater2", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_ML_HANDLER   , "UHandler",   306, "Mechanical : UHandler", 15300, "UHandler", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_ML_HANDLER   , "LHandler",   307, "Mechanical : LHandler", 15300, "LHandler", LOG_ALL, LOG_DAY ),
                new CObjectInfo( (int)OBJ_ML_VISION    , "Vision",     308, "Mechanical : Vision", 15500, "Vision", LOG_ALL, LOG_DAY ),
